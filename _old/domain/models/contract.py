...
try:
    from domain.services.text_normalizer import preprocess_contract_text
...
TESSERACT_PATH = get_secret("TESSERACT_PATH", r"C:\Program Files\Tesseract-OCR\tesseract.exe" if platform.system() == "Windows" else "tesseract")
TESSDATA_DIR = get_secret("TESSDATA_PREFIX", r"C:\Program Files\Tesseract-OCR\tessdata" if platform.system() == "Windows" else None)
POPPLER_PATH = get_secret("POPPLER_PATH", r"C:\poppler-25.12.0\Library\bin>" if platform.system() == "Windows" else None)
...
def setup_ocr():
    ...
    if platform.system() == "Windows":
        ...
        if not shutil.which(tesseract_cmd):
            ...
            common_paths = ["/usr/bin/tesseract", "/usr/local/bin/tesseract", "/Users/sjacu/AppData/Local/ProgramsTesseract-OCR", "C:/Program Files/Tesseract-OCR"]
            found = False
