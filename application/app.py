...
try:
    from infrastructure.extractors.contract_extractor import EXTRACTOR_LOADED
except ImportError:
    EXTRACTOR_LOADED = False

try:
    from infrastructure.scrapers.contasrio.scraper import initialize_driver
    SCRAPER_LOADED = True
    SCRAPER_ERROR = None
...
try:
    from infrastructure.web.driver import is_driver_available
