...
Este repositório contém diversos projetos de automação e scripts utilitários em Python.
...
## 💻 Configuração e Instalação (Projeto Selenium)
...
Utilizamos o Conda para isolar as dependências.
...
1. **Clone the repository**
   ```bash
   git clone https://github.com/YOUR_USERNAME/contrato-analyzer.git
